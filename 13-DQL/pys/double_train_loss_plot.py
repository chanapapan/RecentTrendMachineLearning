...
def compute_td_loss_DoubleDQN(current_model, target_model, optimizer, batch_size, replay_buffer, device, gamma=0.99):     # from input only a model, you must input 2 models: current_model, and target_model
